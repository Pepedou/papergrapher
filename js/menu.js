...
pg.menu = function () {
    ...
    var showAboutModal = function () {
        var html = '<h2 class="appTitle">Papergrapher</h2><span class="versionNumber">' + pg.settings.getVersionNumber() +
            '</span><p>A vector editor for your browser, based on <a href="http://paperjs.org/" target="_blank">Paper.js</a>' +
            ' and <a href="https://github.com/memononen/stylii" target="_blank">stylii</a>.' +
            '</p><p>Originally developed by <a href="https://twitter.com/w00dn" target="_blank">Rolf Fleischmann</a> ' +
            'and built upon by <a href="http://codmex.com" target="_blank">Codificadora México</a>.' +
            '<br>Published under the ' +
            '<a href="https://github.com/w00dn/papergrapher/blob/master/LICENSE" target="_blank">MIT License</a>.</p>' +
            '<p>Icons made by <a href="http://www.flaticon.com/authors/madebyoliver" title="Madebyoliver">Madebyoliver</a> ' +
            'and <a href="http://www.freepik.com" title="Freepik">Freepik</a>.' +
            '<p><a href="http://www.flaticon.com" title="Flaticon">www.flaticon.com</a> is licensed by ' +
            '<a href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0" target="_blank">CC 3.0</a></p>';
